...
{
    public class ApiResponseClanModel
    {
        public ICollection<ClanReadModel> Items { get; set; }
        public PagingReadModel Paging { get; set; }
        ...
        {
            public CursorReadModel Cursors { get; set; }
        }

        public class CursorReadModel { }
    }
}
